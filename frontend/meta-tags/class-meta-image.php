...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'ggd_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( ggd_acf_options() ) {
			...
			$blog_image    = get_field( 'ggd_meta_blog_image', 'option' );
			$default_image = get_field( 'ggd_meta_default_image', 'option' );
