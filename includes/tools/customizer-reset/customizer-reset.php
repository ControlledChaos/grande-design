...
namespace Grande_Design\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'ggd-customizer-reset', GGD_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'ggd-customizer-reset', '_GGDCustomizerReset', [
			'reset'   => __( 'Reset', 'grande-design' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'grande-design' ),
			'nonce'   => [
