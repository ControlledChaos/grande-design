...
class GGD_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once GGD_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once GGD_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['ggd-custom-beaver-field'] = GGD_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'ggd-beaver-fields', GGD_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'ggd-beaver-fields', GGD_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$ggd_beaver_builder = new GGD_Beaver_Builder;