...
namespace Grande_Design\Includes\Media;
...
class Media {
	...
	private function dependencies() {
		...
		include_once GGD_PATH . 'includes/media/class-svg-support.php';

		// Replace WP gallery shortcode if Fancybox option is used.
		$fancybox = get_option( 'ggd_enqueue_fancybox_script' );

		if ( $fancybox ) {
			require_once GGD_PATH . 'includes/media/class-gallery-shortcode.php';
		}
	...
	public function image_sizes() {
		...
		add_image_size( __( 'meta-image', 'grande-design' ), 1200, 630, true );
		 ...
		 */
		add_image_size( __( 'column-thumbnail', 'grande-design' ), 48, 48, true );
	...
	public function rss_featured_images( $content ) {
		...
		$size = apply_filters( 'ggd_rss_featured_image_size', 'medium' );
