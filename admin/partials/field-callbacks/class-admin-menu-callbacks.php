...
class Admin_Menu_Callbacks {
	...
	public function hide_links( $args ) {
		...
		$option = get_option( 'ggd_hide_links' );

		$html = '<p><input type="checkbox" id="ggd_hide_links" name="ggd_hide_links" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="ggd_hide_links"> ' . $args[0] . '</label></p>';
