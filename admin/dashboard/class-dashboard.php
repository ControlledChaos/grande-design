...
class Dashboard {
    ...
    public function metaboxes() {
        ...
        if ( ggd_acf_options() ) {
            ...
            $hide = get_field( 'ggd_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'ggd_hide_welcome' );
            $gutenberg  = get_option( 'ggd_hide_try_gutenberg' );
            $editor     = get_option( 'ggd_classic_editor' );
            $wp_news    = get_option( 'ggd_hide_wp_news' );
            $quickpress = get_option( 'ggd_hide_quickpress' );
            $at_glance  = get_option( 'ggd_hide_at_glance' );
            $activity   = get_option( 'ggd_hide_activity' );
