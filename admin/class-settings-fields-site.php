...
class Settings_Fields_Site {
	...
	public function site_settings() {
		...
		$defaults = [
			...
			'settings_link_label' => __( 'Site Settings', 'grande-design' ),
		...
		return apply_filters ( 'ggd_site_settings', $defaults );
 ...
 */
function ggd_settings_fields_site() {
