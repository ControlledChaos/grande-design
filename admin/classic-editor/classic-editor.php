<?php
/**
 * Restore the classic editor
 *
 * This is a copy of the Classic Editor plugin.
 * It removes the block editor and restores the
 ...
 *
 * @todo       Rewrite this once it is finalized and
