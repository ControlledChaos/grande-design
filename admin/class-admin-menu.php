...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( ggd_acf_options() ) {
            ...
            $options = get_field( 'ggd_admin_hide_links', 'option' );
    ...
    public function hide() {
        ...
        if ( ggd_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'ggd_hide_appearance' );
            $plugins    = get_option( 'ggd_hide_plugins' );
            $users      = get_option( 'ggd_hide_users' );
            $tools      = get_option( 'ggd_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( ggd_acf_options() ) {
            ...
            $menus_link   = get_field( 'ggd_menus_position', 'option' );
            $widgets_link = get_field( 'ggd_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'ggd_menus_position' );
            $widgets_link = get_option( 'ggd_widgets_position' );
